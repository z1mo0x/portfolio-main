    ...
    about: [
        {
            ...
            year: "2025-XXXX",
            descr: "Разработал свое портфолио и начал активно искать клиентов, для разработки. Именно сейчас я развиваюсь, чтобы самостоятельно создавать сайты для всех."
        },
        {
